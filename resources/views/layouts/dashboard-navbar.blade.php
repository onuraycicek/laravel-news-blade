...
<div class="md:flex flex-col md:flex-row md:min-h-screen fixed top-0 left-0 w-full md:w-64">
    <div @click.away="open=false"
        ...
        <div class="flex-shrink-0 px-8 py-4 flex flex-row items-center justify-between">
            <a href="#"
                class="text-lg font-semibold tracking-widest text-gray-900 uppercase rounded-lg dark-mode:text-white focus:outline-none focus:shadow-outline">KozmoNews</a>
